...
class GUI_Two:
    ...
    def LoadTextures(self):
        image = pygame.image.load('G2.png')
    ...
    def keyboard(self):
        if self.keystrokes[ord('e')]:
            game = Game(True, True, 0.0001)
            game.main()
        elif self.keystrokes[ord('m')]:
            game = Game(True, False, 0.001)
            game.main()
        elif self.keystrokes[ord('h')]:
            game = Game(True, False, 0.05)
            game.main()
    def Display(self):
